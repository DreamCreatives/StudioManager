...
import {
  ...
  a_equipment_create,
  a_equipment_delete,
  a_equipment_reservation_create,
  a_equipment_reservation_delete
...
export class ActionService {
  ...
  createEquipmentReservation() { return a_equipment_reservation_create(this.viewService, this.apiService, this.wizardService) }
  deleteEquipmentReservation() { return a_equipment_reservation_delete(this.viewService, this.apiService, this.yesNoService) }
